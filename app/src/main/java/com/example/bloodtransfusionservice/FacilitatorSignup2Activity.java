...
public class FacilitatorSignup2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facilitator_signup2);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(getAge(year, month, day) >= 18)) {
                    Toast.makeText(FacilitatorSignup2Activity.this, "Please check your date of birth again", Toast.LENGTH_SHORT).show();
                } else {
                    if (!male.isChecked() && !female.isChecked() && !other.isChecked()) {
                        Toast.makeText(FacilitatorSignup2Activity.this, "Please select gender", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(FacilitatorSignup2Activity.this, FacilitatorSignup3Activity.class);
