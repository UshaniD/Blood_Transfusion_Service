...
public class FacilitatorInfoActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    FacilitatorInfoHolder facilitatorInfoHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.view_facilitator);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<>();
        facilitatorInfoHolder = new FacilitatorInfoHolder(this, list);
        recyclerView.setAdapter(facilitatorInfoHolder);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                        storeFacilitatorData data = snapshot.getValue(storeFacilitatorData.class);
                        facilitatorInfoHolder.notifyDataSetChanged();
        ...
        facilitatorInfoHolder.OnRecyclerViewClickListner(new FacilitatorInfoHolder.OnRecyclerViewClickListner() {
            @Override
            public void onViewMoreClick(int position, String id) {
                ...
                Intent intent = new Intent(getApplicationContext(), FacilitatorDetailsActivity.class);
