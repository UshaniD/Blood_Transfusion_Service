...
public class CampaignsHolder extends RecyclerView.Adapter<CampaignsHolder.CampViewHolder> {
    Context context;
    ArrayList<storeCampaignData> list;

    private CampaignsHolder.OnRecyclerViewClickListner listner;

    public interface OnRecyclerViewClickListner {
        void onViewMoreClick(int position, String id);
    }

    public void OnRecyclerViewClickListner(CampaignsHolder.OnRecyclerViewClickListner listner) {
        this.listner = listner;
    }

    public CampaignsHolder(Context context, ArrayList<storeCampaignData> list) {
    ...
    public static class CampViewHolder extends RecyclerView.ViewHolder {
        ...
        public CampViewHolder(@NotNull View itemView, CampaignsHolder.OnRecyclerViewClickListner listner) {
            super(itemView);
