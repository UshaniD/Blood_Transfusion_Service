...
public class BloodReceivedRegistryActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    GridLayout gridLayout;
    BloodReceivedHolder bloodReceivedHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blood_received_registry);

        received_date = findViewById(R.id.input_blood_received_date);
        ...
        recyclerView = findViewById(R.id.blood_received_registry);
        gridLayout = findViewById(R.id.blood_received_grid);
        ...
        list = new ArrayList<>();
        bloodReceivedHolder = new BloodReceivedHolder(this, list);
        recyclerView.setAdapter(bloodReceivedHolder);
        ...
        buttonSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int day = received_date.getDayOfMonth();
                int month = received_date.getMonth() + 1;
                int year = received_date.getYear();

                DateFormat outputFormat = new SimpleDateFormat("yyyy/MM/dd", Locale.US);
                DateFormat inputFormat = new SimpleDateFormat("yyyy/MM/dd", Locale.US);
                String receivedDate_ = "" + year + "/" + month + "/" + day;
                Log.d("receivedDate_ : ", String.valueOf(receivedDate_));

                Date date = null;
                try {
                    date = inputFormat.parse(receivedDate_);
                ...
                checkFacilitatorDistrict.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            Query query = databaseReference.orderByChild("donatedDistrict").equalTo(facilitatorDistrict);
