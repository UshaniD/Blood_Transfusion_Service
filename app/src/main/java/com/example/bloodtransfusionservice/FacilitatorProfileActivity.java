...
public class FacilitatorProfileActivity extends AppCompatActivity {
    TextInputLayout txtFullname, txtEmail, txtNic, txtPassword;
    TextView txtPhone, txtEmpNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("facilitator");
        ...
        txtEmpNo = findViewById(R.id.txt_emp_no);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String txtEmpNo_var = txtEmpNo.getText().toString();
                                                ...
                                                if (!place_var.isEmpty()) {
                                                    if (getAge(year, month, day) >= 18) {
                                                        if (!male.isChecked() && !female.isChecked() && !other.isChecked()) {
                                                            Toast.makeText(FacilitatorProfileActivity.this, "Please select gender", Toast.LENGTH_SHORT).show();
                                                        } else if (male.isChecked()) {
                                                            gender = "Male";

                                                            if(!districts_var.equals(district_var_db)){
                                                                new AlertDialog.Builder(FacilitatorProfileActivity.this)
                                                                        ...
                                                                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                                                            public void onClick(DialogInterface dialog, int whichButton) {
                                                                                ...
                                                                                storeFacilitatorData storedata = new storeFacilitatorData(phone, fullname_var, email_var, nic_var, encryptedPassword, txtEmpNo_var, districts_var, dob_, gender, place_var, address_var);
                                                                                reference.child(phone).setValue(storedata);

                                                                                Toast.makeText(getApplicationContext(), "Updated successfully", Toast.LENGTH_SHORT).show();
                                                                                Intent intent = new Intent(FacilitatorProfileActivity.this, FacilitatorLeftNavActivity.class);
                                                        ...
                                                        Toast.makeText(FacilitatorProfileActivity.this, "Please check your date of birth again", Toast.LENGTH_SHORT).show();
                                                    }
                                                } else {
    ...
    private void pickPointOnMap() {
        ...
        Intent pickPointIntent = new Intent(FacilitatorProfileActivity.this, ChooseLocationActivity.class);
        ...
        checkmobile.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    String txtEmpNo_var = snapshot.child(phone_var).child("empid").getValue(String.class);
                    ...
                    ArrayAdapter arrayAdapter1 = new ArrayAdapter(FacilitatorProfileActivity.this, R.layout.format_dropdown, district_options);
